...
transcript file ../reports/regression_transcript
...
# Load project
  eval vsim -novopt -quiet -GWR_NR=$1 -GRD_NR=$2 -GWRITE_ORDER=$3 -GREAD_ORDER=$4 -nocoverage +notimingchecks +nowarnTSCALE -sva top
