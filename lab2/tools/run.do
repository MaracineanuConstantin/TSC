...
## transcript file ../reports/regression_transcript.txt
...
# eval vsim -novopt -quiet -GWR_NR=$1 -GRD_NR=$2 -GWRITE_ORDER=$3 -GREAD_ORDER=$4 -GTEST_CASE=$5 -GSEED_VAL=$6 -coverage +code=bcesft +notimingchecks +nowarnTSCALE -sva top
